...
import {connect as connectUdp, setSessionDescription} from "./stream.js";
import {streamReady} from "./bot.js";
...
export const setRtcServerId = (id) => {
    metadata.server_id = id;
}

export const setMetadata = (user_id, session_id, {token, endpoint}) => {
...
export const connect = () => {
    ...
    ws.on("close", (data) => console.log("Stream connection closed", data));
}

const send = (opcode, data) => {
    console.log(" STREAM -> ", opcode, opcodes[opcode], data);
